        ...
        while ( ( ctrl != -1 ) && ( ctrl < raw.length ) ) {
            ...
            switch ( raw[ ctrl + 1 ] ) {
                ...
                case "a":
                    ...
                    const attr = parseInt( "0x" + raw.substring( ctrl + 2, 2 ) );
                ...
                case "C":
                case "c":
                    this.charVal( parseInt( "0x" + raw.substring( ctrl + 2, 2 ) ) );
                    ctrl += 4;
                    break;
            ...
            // Chop the bits we've one off the raw string.
...
function NGLine2PlainText( line ) {
    let s = "";
    ( new NGLineParser( { text: t => s += t } ) ).parse( line );
    return s;
}
