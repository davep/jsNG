...
function NGBuffer( buffer ) {
    ...
    // Read a string.
    this.readString = ( length, decrypt ) => {
    ...
    this.readStringZ = ( maxlen, decrypt ) => {
...
function NGMenu( ng ) {
    ...
    this.prompt      = ( i ) => prompts[ i ].prompt;
    this.offset      = ( i ) => prompts[ i ].offset;
...
function NGSeeAlso( ng ) {
    ...
    this.prompts      = ()    => seeAlsos.map( ( seeAlso ) => seeAlso.prompt );
    this.seeAlso      = ( i ) => seeAlsos[ i ].prompt;
    this.offset       = ( i ) => seeAlsos[ i ].offset;
